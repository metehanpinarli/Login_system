...
import 'package:imza_app/Utils/userExit.dart';
...
class _ExitScreenState extends State<ExitScreen> {
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Spacer(),
                Expanded(flex: 1, child: logoutText(context)),
                      ...
                      onPressed: () async {
                        ...
                        if (resultNet.netAnswer == true) {
                          ...
                          if (tfUserPass.text.isEmpty) {
                            ...
                            var result = await Logout().userLogout(tfUserPass.text);
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                        onPressed: () async {
                          scaffold.hideCurrentSnackBar();
                          print(pass);
                          var userVerificationRest = await Logout().userVerificationLogout(pass);
                          if (userVerificationRest.answer == true) {
                            ...
                            scaffold.showSnackBar(
                              SnackBar(
                                ...
                                content: Center(
                                    child: Text(
                                  "Çıkış Başarılı  Tarih: $date Saat: $time",
                                  style: Theme.of(context).textTheme.headline5!.copyWith(fontWeight: FontWeight.bold, color: Colors.white),
                                )),
  ...
  Text logoutText(BuildContext context) {
    return Text(
      "Çıkış Yapmak İçin Lütfen Şifrenizi Giriniz",
